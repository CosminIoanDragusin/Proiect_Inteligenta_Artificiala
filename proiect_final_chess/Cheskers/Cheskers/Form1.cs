...
namespace Cheskers
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            chessSprites = new Bitmap("C:\\Users\\user\\Desktop\\proiect al\\proiect_final_chess\\Cheskers\\chess_good.png");
        ...
        public void ShowSteps(int IcurrFigure, int JcurrFigure, int currFigure)
        {
            ...
            {
                case 6:
                    if (InsideBorder(IcurrFigure + 1 * dir, JcurrFigure+1*dir))
                    {
                        if (map[IcurrFigure + 1 * dir, JcurrFigure+1*dir] == 0)
                        {
                            butts[IcurrFigure + 1 * dir, JcurrFigure+1*dir].BackColor = Color.Yellow;
                            butts[IcurrFigure + 1 * dir, JcurrFigure+1*dir].Enabled = true;
                        }
                    }
                    if (InsideBorder(IcurrFigure + 1 * dir, JcurrFigure - 1 * dir))
                    {
      ...
      public static string AlphaBetaMax(int position,int depth,int alpha,int beta,bool maximPlayer)
        {
            return "";
        }
    }
